...
def general_provision_store():
    """ Welcome to my General Provision Store game. Here you will play a customer and order items, and I will sum them
    up and give you a receipt.
    """
    ...
    while True:
        ...
        # Quits the order if the input is 'q'
        if choice.lower() == 'q':
