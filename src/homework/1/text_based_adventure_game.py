...
# [About Black Citadel]
# In the land of whimsy and wonder, there stands the Black Citadel, and old, spooky castle haunted with ghosts. These
# wandering spirits were once brave soldiers who fought in an intense war a long time ago. Legend has it that somewhere
# inside the castle, there is an awesome treasure map to be discovered! Loads of daring adventurers have come to the
...
resources = {
    ...
    'actions': [
        ...
        [Action.LOOK, Action.INVESTIGATE, Action.UP, Action.LEFT, Action.RIGHT, Action.OUT],
        [Action.LOOK, Action.INVESTIGATE, Action.UP, Action.LEFT],
        [Action.LOOK, Action.INVESTIGATE, Action.UP, Action.DOWN, Action.RIGHT],
        [Action.LOOK, Action.INVESTIGATE, Action.UP, Action.DOWN, Action.LEFT, Action.RIGHT],
    ...
    'action_prompt': [
        ...
        f'{bold("enter")} the Black Castle',
        f'get {bold("out")} of the Black Castle',
    ],
    ...
    'text': {
        Action.LOOK: [
            ...
            'This is the hall of the castle. There is a grand staircase leading to the second floor.',
...
def text_based_adventure_game():
    print_backstory()
    print("Now you are standing at the entrance of the Black Citadel. You can either enter the Black Citadel or turn "
          "back.")

    position = 0  # the position of the player
    has_entered = False  # whether the player has entered the castle
    ...
    while True:
        ...
        # If the position is 0, which is at the entrance of the castle, and the player has entered the castle, the game
        # is over.
...
def print_backstory():
    ...
    """
    backstory = [
        "In the land of whimsy and wonder, there stands the Black Citadel, and old, spooky castle haunted with ghost.",
        "These wandering spirits were once brave soldiers who fought in an intense war a long time ago. Legend has it ",
        "that somewhere inside the castle, there is an awesome treasure map to be discovered! Loads of daring ",
        "adventurers have come to the Black Citadel, all excited to find the treasure map. However, nobody has ever ",
        "made it our of there!"
    ]
    print('\n'.join(backstory))
...
def game_over(treasure_map_piece_num: int):
    ...
    print('Special Thanks: ChatGPT helped me refine the backstory and room descriptions.')
